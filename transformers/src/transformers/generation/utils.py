...
from ..cache_utils import QuantizedCacheLM, QuantizedCacheVLM, QuantizedCacheVLMSTP
...
class GenerationMixin:
    ...
    def _prepare_cache_for_generation(
        ...
        """
        QUANT_BACKEND_CLASSES_MAPPING = {"quanto": QuantoQuantizedCache, "HQQ": HQQQuantizedCache, "QuantizedCacheLM": QuantizedCacheLM, "QuantizedCacheVLM": QuantizedCacheVLM, "QuantizedCacheVLMSTP": QuantizedCacheVLMSTP}
        ...
        if generation_config.cache_implementation is not None:
            if generation_config.cache_implementation in NEED_SETUP_CACHE_CLASSES_MAPPING:
                ...
                if self.low_tokens is not None:
                    cache_config.rel_tokens = self.rel_tokens
                    cache_config.low_tokens = self.low_tokens
